...
@section('subtitle', 'Profil Madrasah')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Profil Madrasah</li>
@endsection
                ...
                <form id="schoolForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                            name="nama" value="{{ old('nama', $sekolah->nama) }}" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('npsn') is-invalid @enderror" id="npsn"
                            name="npsn" value="{{ old('npsn', $sekolah->npsn) }}" required>
                        @error('npsn')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('nsm') is-invalid @enderror" id="nsm"
                            name="nsm" value="{{ old('nsm', $sekolah->nsm) }}" required>
                        @error('nsm')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('notelp') is-invalid @enderror" id="notelp"
                            name="notelp" value="{{ old('notelp', $sekolah->notelp) }}" required>
                        @error('notelp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            name="email" value="{{ old('email', $sekolah->email) }}" required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control @error('website') is-invalid @enderror" id="website"
                            name="website" value="{{ old('website', $sekolah->website) }}" required>
                        @error('website')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select name="kepala_sekolah_id" id="kepala_sekolah_id"
                            ...
                            @foreach ($guru as $item)
                                <option value="{{ $item->id }}"
                                    {{ $item->id == $sekolah->kepala_sekolah_id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select name="bendahara_id" id="bendahara_id"
                            class="form-control @error('bendahara_id') is-invalid @enderror">
                            <option disabled selected>Pilih salah satu</option>
                            @foreach ($guru as $item)
                                <option value="{{ $item->id }}"
                                    {{ $item->id == $sekolah->bendahara_id ? 'selected' : '' }}>
                                    {{ $item->nama_lengkap }} {{ $item->gelar_belakang }}
                                </option>
                            @endforeach
                        </select>
