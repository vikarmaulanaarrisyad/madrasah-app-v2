            ...
            <x-card>
                <x-slot name="header">
                    ...
                    <div class="card-tools">
                        <div class="d-flex align-items-center">
                            <div>
                                <button onclick="addForm(`{{ route('fasilitas.store') }}`)" class="btn btn-sm btn-primary">
                ...
                <x-table>
                    <x-slot name="thead">
                        ...
                        <th>Gambar</th>
                        <th>Nama</th>
                        <th style="word-wrap: break-word; white-space: normal; max-width: 200px;">Deskripsi</th>
                        <th>Aksi</th>
                    </x-slot>
                </x-table>
            </x-card>
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Fasilitas Madrasah') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Fasilitas Madrasah') {
            Swal.fire({
                title: "Memuat...",
