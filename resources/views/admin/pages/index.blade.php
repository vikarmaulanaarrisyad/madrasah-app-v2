            ...
            <x-card>
                <x-slot name="header">
                    ...
                    <div class="card-tools">
                        <button onclick="addForm(`{{ route('pages.store') }}`)" class="btn btn-sm btn-primary"><i
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Halaman') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Halaman') {
            Swal.fire({
                title: "Memuat...",
