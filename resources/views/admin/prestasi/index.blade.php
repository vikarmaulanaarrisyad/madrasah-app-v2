                ...
                <x-slot name="header">
                    ...
                    <div class="card-tools">
                        <div class="d-flex align-items-center">
                            <div>
                                <button onclick="addForm(`{{ route('prestasi.store') }}`)" class="btn btn-sm btn-primary">
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Data Prestasi') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Data Prestasi') {
            Swal.fire({
                title: "Memuat...",
