                ...
                <x-slot name="header">
                    ...
                    <div class="card-tools">
                        <div class="d-flex align-items-center">
                            <div>
                                <button onclick="addForm(`{{ route('k13kd.create') }}`)" class="btn btn-sm btn-primary">
                                    <i class="fas fa-plus-circle"></i> Tambah Kompetensi Dasar
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        function addForm(url) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    }, 1500); // Bisa disesuaikan durasinya
                }
            });
        }

        function editForm(url, title = 'Data Kompetensi Dasar') {
            Swal.fire({
                title: "Memuat...",
                text: "Mohon tunggu sebentar...",
                allowOutsideClick: false,
            ...
            $.get(url)
                .done(response => {
                    ...
                    $('#mapel').val(response.data.matapelajaran.nama)
                    $('#kode_kd').val(response.data.kode_kd)
                })
                .fail(errors => {
