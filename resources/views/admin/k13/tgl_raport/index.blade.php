...
@section('subtitle', 'Tanggal Raport')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Tanggal Raport</li>
@endsection
...
@section('content')
                ...
                <x-slot name="header">
                    <div class="card-tools">
                        <div class="d-flex align-items-center">
                            <div>
                                <button onclick="addForm(`{{ route('k13tglraport.store') }}`)" class="btn btn-sm btn-primary">
    ...
    @include('admin.k13.tgl_raport.form')
@endsection
    ...
    <script>
        ...
        table = $('.table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'tempat_penerbitan'
                },
                {
                    data: 'tanggal_pembagian'
                },
                {
                    data: 'aksi',
                    name: 'aksi',
        ...
        function addForm(url, title = 'Tanggal Raport') {
            $(modal).modal('show');
