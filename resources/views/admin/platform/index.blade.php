                ...
                <x-slot name="header">
                    ...
                    <div class="card-tools">
                        <div class="d-flex align-items-center">
                            <div>
                                <button onclick="addForm(`{{ route('platform.store') }}`)" class="btn btn-sm btn-primary">
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Platform') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Platform') {
            Swal.fire({
                title: "Memuat...",
