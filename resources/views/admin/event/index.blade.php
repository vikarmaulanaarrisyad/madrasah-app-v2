            ...
            <x-card>
                <x-slot name="header">
                    ...
                    <div class="card-tools">
                        <button onclick="addForm(`{{ route('event.store') }}`)" class="btn btn-sm btn-primary"><i
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Event') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Event') {
            Swal.fire({
                title: "Memuat...",
