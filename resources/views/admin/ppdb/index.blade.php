...
@section('subtitle', 'Pengumuman PPDB')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item active">Pengumuman PPDB</li>
@endsection
                    ...
                    @if (!$ppdb)
                        <div class="card-tools">
                            <div class="d-flex align-items-center">
                                <div>
                                    <button onclick="addForm(`{{ route('ppdb.store') }}`)" class="btn btn-sm btn-primary">
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Informasi PPDB') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Informasi PPDB') {
            Swal.fire({
                title: "Memuat...",
