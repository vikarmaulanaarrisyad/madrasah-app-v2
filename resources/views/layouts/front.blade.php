...
<body>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150"
            style="background-image: url({{ asset('education') }}/images/slider/s-1.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img
                                            src="{{ asset('education') }}/images/course/teacher/t-1.jpg"
                                            alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img
                                            src="{{ asset('education') }}/images/course/teacher/t-2.jpg"
                                            alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img
                                            src="{{ asset('education') }}/images/course/teacher/t-3.jpg"
                                            alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img
                                            src="{{ asset('education') }}/images/course/teacher/t-4.jpg"
                                            alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#">
                    ...
                    <div class="singel-course">
                        ...
                        <div class="cont">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="#"><img
                                            src="{{ asset('education') }}/images/course/teacher/t-5.jpg"
                                            alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('education') }}/images/publication/p-1.jpg" alt="Publication">
                            <div class="add-cart">
                                <ul>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('education') }}/images/publication/p-2.jpg" alt="Publication">
                            <div class="add-cart">
                                <ul>
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('education') }}/images/publication/p-3.jpg" alt="Publication">
                            <div class="add-cart">
                                <ul>
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="singel-publication mt-30">
                        <div class="image">
                            <img src="{{ asset('education') }}/images/publication/p-4.jpg" alt="Publication">
                            <div class="add-cart">
                                <ul>
                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
    ...
    <section id="testimonial" class="bg_cover pt-115 pb-115" data-overlay="8"
        style="background-image: url({{ asset('education') }}/images/bg-2.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row testimonial-slied mt-40">
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ asset('education') }}/images/testimonial/t-1.jpg" alt="Testimonial">
                            <div class="quote">
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ asset('education') }}/images/testimonial/t-2.jpg" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="{{ asset('education') }}/images/testimonial/t-3.jpg" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="singel-news mt-30">
                        <div class="news-thum pb-25">
                            <img src="{{ asset('education') }}/images/news/n-1.jpg" alt="News">
                        </div>
                        <div class="news-cont">
                            <ul>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('education') }}/images/news/ns-1.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('education') }}/images/news/ns-2.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('education') }}/images/news/ns-3.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="#"><img src="{{ asset('education') }}/images/logo-2.png"
                                        alt="Logo"></a>
                            </div>
